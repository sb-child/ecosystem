...
- (fork) [whirlwind](./libraries/whirlwind.md) ![rs](https://img.shields.io/badge/-rust-black?logo=Rust) 异步线程安全 [HashMap](https://doc.rust-lang.org/beta/std/collections/struct.HashMap.html) 实现
...
- (fork) [reed-solomon-rs](./libraries/reed-solomon-rs.md) ![rs](https://img.shields.io/badge/-rust-black?logo=Rust) 纠错算法 [Reed-Solomon](https://en.wikipedia.org/wiki/Reed%E2%80%93Solomon_error_correction) 的编解码器实现
...
- (fork) [addr](./libraries/addr.md) ![rs](https://img.shields.io/badge/-rust-black?logo=Rust) 域名/邮箱地址解析与校验器实现
- [ads1298-rs](./libraries/ads1298-rs.md) ![rs](https://img.shields.io/badge/-rust-black?logo=Rust) 生物电信号采集芯片 [ADS1298](https://www.ti.com/product/ADS1298) 的驱动程序
...
- [myqqbot](./myqqbot.md)
- [lsp](./lsp.md)
- [bilibili-daily-task](./bilibili-daily-task.md)
...
- [DarkDrop](./darkdrop.md)

## 轻工业

- 自制 HRT 药物相关，[查看详情](./diyhrtdrugs.md)。

## meme

- [Transport](./transport.md)
- [Triple](./triple.md)
- [rimochan-home](./rimochan-home.md)
- [unv-coin](./unv-coin.md)
- [crossdressing-principle](./crossdressing-principle.md)
- [unv-docs](./unv-docs.md)

## 关于我（以及我的精神遗产）

- [for-you](./for-you.md)
- [but-similar](./but-similar.md)
- [notes](./notes.md)
- [Crossdress](./crossdress.md)
